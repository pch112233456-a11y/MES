...
const API_BASE_URL = 'https://mes-backend-d761.onrender.com'
...
function FileUpload({ onUploadSuccess }) {
  ...
  const uploadFile = async (targetFile) => {
    ...
    try {
      ...
      if (!response.ok) {
        let message = '파일 분석 중 오류가 발생했습니다.'
      ...
      >
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <div>
              <p className="text-slate-700 font-medium text-sm max-w-[300px] truncate">
                {file.name}
              </p>
